! function () {
    ...
    function F(t, n, i, e, o, a, s) {
       this.v = t, this.B = n, this.c = i, this.a = e, this.s = s || "BESbswy", this.f = {}, this.w = o || 3e3, this.u = a || null, this.o = this.j = this.h = this.g = null, this.g = new N(this.c, this.s), this.h = new N(this.c, this.s), this.j = new N(this.c, this.s), this.o = new N(this.c, this.s), t = E(t = new y(this.a.c + ",serif", j(this.a))), this.g.a.style.cssText = t, t = E(t = new y(this.a.c + ",sans-serif", j(this.a))), this.h.a.style.cssText = t, t = E(t = new y("serif", j(this.a))), this.j.a.style.cssText = t, t = E(t = new y("sans-serif", j(this.a))), this.o.a.style.cssText = t, A(this.g), A(this.h), A(this.j), A(this.o)
    }
    ...
    function L(t) {
       var n, o = t.g.a.offsetWidth,
          a = t.h.a.offsetWidth;
       (n = o === t.f.serif && a === t.f["sans-serif"]) || (n = B() && O(t, o, a)), n ? e() - t.A >= t.w ? B() && O(t, o, a) && (null === t.u || t.u.hasOwnProperty(t.a.c)) ? D(t, t.v) : D(t, t.B) : function (t) {
          ...
          if (0 === e.length && s) T(n.a);
             ...
             for (f = 0; f < e.length; f++) {
                var l = e[f],
                   ...
                   p = n.a,
                   d = l;
                p.g && c(p.f, [p.a.c("wf", d.c, j(d).toString(), "loading")]), S(p, "fontloading", d), p = null, null === q && (q = !!window.FontFace && (!(d = /Gecko.*Firefox\/(\d+)/.exec(window.navigator.userAgent)) || 42 < parseInt(d[1], 10))), p = q ? new W(i(n.g, n), i(n.h, n), n.c, l, n.s, u) : new F(i(n.g, n), i(n.h, n), n.c, l, n.s, t, u), h.push(p)
             }
    ...
    $.prototype.g = function (t) {
       var n = this.a;
       n.g && c(n.f, [n.a.c("wf", t.c, j(t).toString(), "active")], [n.a.c("wf", t.c, j(t).toString(), "loading"), n.a.c("wf", t.c, j(t).toString(), "inactive")]), S(n, "fontactive", t), this.o = !0, H(this)
                   ...
                   for (var r, f = (r = r.split(",")).length, c = 0; c < f; c++) {
                      ...
                      if ((h = r[c]).match(/^[\w-]+$/))
                         if (null == (l = Y.exec(h.toLowerCase()))) h = "";
                            ...
                            if (h = null == (h = l[2]) || "" == h ? "n" : X[h], null == (l = l[1]) || "" == l) l = "4";
                            else var l = V[l] || (isNaN(l) ? "4" : l.substr(0, 1));
                            h = [h, l].join("")
                         }
                      else h = "";
                      h && s.push(h)
                   }
                0 < s.length && (a = s), 3 == e.length && (s = [], 0 < (e = (e = e[2]) ? e.split(",") : s).length && (e = Q[e[0]]) && (t.c[o] = e))
             }
             for (t.c[o] || (e = Q[o]) && (t.c[o] = e), e = 0; e < a.length; e += 1) t.a.push(new y(o, a[e]))
          }
       }(a), u(i, function (t) {
